...
const ContactUs = () => {
  ...
  return (
    <div>
      <div className="my-10 p-5 rounded-lg bg-gradient-to-r from-[#141E30] to-[#243B55] w-[60%] mx-auto text-white">
        ...
        >
          <input
            className="focus:outline-none rounded-md w-[70%] mx-auto py-3 px-5"
